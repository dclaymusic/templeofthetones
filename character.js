function Character()
{
	...
	this.sprites = {};
	this.sprites[directions.up] = [{x:tileW*2, y:tileH*0, w:tileW, h:tileH}];
	this.sprites[directions.right] = [{x:tileW*2, y:tileH*0, w:tileW, h:tileH}];
	this.sprites[directions.left] = [{x:tileW*2, y:tileH*0, w:tileW, h:tileH}];
	this.sprites[directions.down] = [{x:tileW*2, y:tileH*0, w:tileW, h:tileH}];
...
{
	if((x<0 || x>=mapW || y<0 || y>=mapH) || !canMove) { return false; }
